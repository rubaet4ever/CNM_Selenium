...
import com.cnm.clickndoc.RequirementsTest;
...
import com.cnm.clicknshare.UserTest;
	...
	private static WebDriver getChromeDriver(String serverUrl) {
			...
			final String DRIVER_URL =  "D:\\Automation Testing Tools\\Selenium\\chromedriver_win32\\chromedriver.exe";
			...
			//LoginPage loginPage =  homepage.clickForAuthenication();
			//loginPage.setUsername("smith");
			//loginPage.setPassword("Sasdsa!");
			//SecureAreaPage secureAreaPage = loginPage.clickLoginButton();
			//assertEquals(secureAreaPage.getAlertText(), s1:"You logged into a secure area! x" , s2:"Alert text is incorrect";
...
private static WebDriver getFirefoxDriver(String serverUrl) {
			...
			final String DRIVER_URL = "D:\\Automation Testing Tools\\Selenium\\chromedriver_win32\\geckodriver.exe";
